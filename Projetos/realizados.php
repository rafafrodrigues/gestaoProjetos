		   		...
		   		<div class="col-md-9 col-sm-3 col-sm-12 bg-light">
		  			...
		  			<div class="container table-responsive">
			  			  	...
			  			  	<table class="table table-bordered table-striped table-hover text-center table-secondary">
			  			  		...
			  			  		<?php
			  			  		$query_projetos_equipe = "select tb_projetos.nome, tb_projetos.tarefas, tb_projetos.colaborador, tb_projetos.auxiliando, tb_projetos.equipe, tb_projetos.criado, tb_projetos.modificado, st.status as st_status FROM tb_projetos inner join tb_status as st on st.id_status=tb_projetos.id_status 
