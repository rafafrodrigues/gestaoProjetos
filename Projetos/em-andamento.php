		    	...
		    	<div class="col-md-3 menu mb-2" class="collapse navbar-collapse" id="nav-menu-lateral">		<!-- início menu lateral -->	   
		   		...
		   		<div class="col-md-9 col-sm-3 col-sm-12 bg-light">
		  			...
		  			<div class="container table-responsive">
			  			  	<h2 class="display-4 text-info mt-3 mb-3">Projetos Em andamento</h2>
			  			  	<table class="table table-bordered table-striped table-hover text-center table-secondary">
			  			  		...
			  			  		<?php
			  			  		$query_projetos_equipe = "select tb_projetos.nome, tb_projetos.tarefas, tb_projetos.colaborador, tb_projetos.auxiliando, tb_projetos.prazo, tb_projetos.equipe,
			  			  			tb_projetos.users_id,
			  			  		...
			  			  		extract($row_proj);
			  			  			if ($st_status == 'Em andamento' && $_SESSION['id'] == $id_users) {
			  			  				echo "<tr>";
			  			  				echo "<td>$nome</td>";
			  			  				echo "<td>$tarefas</td>";
